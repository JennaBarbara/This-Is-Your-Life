export const Acolyte = {
  ...
  "2": "My family gave me to a temple, since they were un- able or unwilling to care for me.",
  ...
  "6": "After encountering a true servant ofthe gods, I was so inspired that I immediately entered the service of a religious group.",
   n : 1,
   d : 6
};
...
export const Criminal = {
  ...
  "3": "I fell in with a gang of reprobates and ne’er-dowells, and I learned my specialty from them.",
...
export const Entertainer = {
  "1": "Members ofmy family made ends meet by performing, so it was fitting for me to follow their example.",
...
export const GuildArtisan = {
  ...
  "6": "I learned the essentials of my craft from a mentorbut had to join the guild to finish my training.",
   n : 1,
   d : 6
};
...
export const Outlander = {
  ...
  "5": "After a tragedy I retreated to the wilderness, leaving old life behind.",
...
export const Sage = {
  ...
  "3": "I was always an avid reader, and I learned much I about my favorite topic on my own.",
...
export const Druid = {
  ...
  "6": "I have always felt disgust for creatures of unnatural origin. For this reason, I immersed myself in the study ofthe druidic mysteries and became a champion of the natural order.",
   n : 1,
   d : 6
};
